    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: GetBuilder<ImageController>(
          builder: (controller) {
            return controller.getAllVideo!.isNotEmpty
                ? ListView.separated(
                    itemBuilder: (context, index) {
                      return ListTile(
                        onTap: () {
                          controller.openFileWithDefaultApp(
                              controller.getAllVideo!.elementAt(index));
                        },
                        leading: Icon(
                        ...
                        title: FutureBuilder<File>(
                          future: controller.getAllVideo![index].getFile(),
                    ...
                    itemCount: controller.getAllVideo!.length,
                  )
                : Center(
